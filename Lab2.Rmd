...
**This assignment is due by the end of the day (11.59pm). Only one student in the group submits a pdf file on Gradescope.**
...
Choose one question about that the data that you want to investigate. Write two hypotheses related to this question using a numbered list below:
